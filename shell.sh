...
pipenv run python main.py train-gensim $DATA/europarl/en $ROOT/europarl/en.gensim --workers 16
pipenv run python main.py train-gensim $DATA/wikipedia/en $ROOT/wikipedia/en.gensim --workers 16
